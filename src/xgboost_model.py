...
class XGBoostModel:
    ...
    def hyperparameter_tuning(self, X_train: pd.DataFrame, y_train: pd.Series,
        ...
        pd.DataFrame(grid_search.cv_results_).to_csv("results/xgb_gridsearch_results.csv", index=False)
        print(f"Best params: {grid_search.best_params_}")
        print("Saved: results/xgb_best_params.json, results/xgb_gridsearch_results.csv")
